...
export function PageOutline({ items }: PageOutlineProps) {
  ...
  return (
    ...
    >
      <div
        className="max-h-[calc(100dvh-8rem)] w-9 overflow-y-auto overflow-x-hidden rounded-2xl border border-border/60 bg-popover/90 p-1.5 shadow-subtle transition-[width,padding,background-color,box-shadow] duration-200 ease-out group-hover/outline:w-72 group-hover/outline:p-2 group-hover/outline:bg-popover group-hover/outline:shadow-md group-has-[:focus-visible]/outline:w-72 group-has-[:focus-visible]/outline:p-2 group-has-[:focus-visible]/outline:bg-popover group-has-[:focus-visible]/outline:shadow-md motion-reduce:transition-none"
        data-outline-panel
      >
