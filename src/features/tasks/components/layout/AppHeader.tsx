...
export function AppHeader({ onCreateProject }: AppHeaderProps) {
  ...
  return (
    <header className="flex shrink-0 items-center gap-2 border-b bg-background px-3 py-2 max-md:pt-[calc(var(--safe-top)+0.5rem)] sm:gap-3 sm:px-4 md:rounded-2xl md:border">
