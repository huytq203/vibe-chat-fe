...
export function InvitePhoneShell({ children }: { children: ReactNode }) {
  return (
    <div className="flex min-h-svh items-center justify-center bg-[#0d0a14] p-4">
      ...
      <div className="relative z-[1] flex h-[calc(100dvh-32px)] max-h-[820px] w-full max-w-[420px] flex-col overflow-hidden rounded-3xl border border-border bg-muted shadow-[0_32px_80px_rgba(0,0,0,0.7)]">
        {children}
      </div>
    </div>
  );
