...
/**
 * Dock điều hướng dưới cùng của ConversationList — nằm trong cột sidebar, 4 tab:
 * Chat · Bạn bè · Thông báo · Tôi. Bạn bè/Thông báo mở qua overlay panel riêng.
 */
export function ConversationDock() {
  ...
  return (
    <>
      <nav className="flex justify-center items-center  border-t">
        <TabButton
          icon={<MessageSquare className="h-[26px] w-[26px]" />}
          label="Chat"
